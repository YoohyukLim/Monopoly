...
public class Board {
	...
	public void refreshInfo() {
		...
		infoside.removeAll();
		playerNameLabel
				.setText("플레이어: " + players.get(currentPlayer).getName());
		playerNameLabel.setForeground(Color.WHITE);
		playerNameLabel.setFont(new Font("맑은 고딕", Font.BOLD, 27));
		currentTurnLabel.setText("턴 수: "
				+ String.valueOf(gameController.getTurn()));
		currentTurnLabel.setForeground(Color.WHITE);
		currentTurnLabel.setFont(new Font("맑은 고딕", Font.BOLD, 23));
		rotationCntLabel.setText("돌은 바퀴 수: "
				+ String.valueOf(players.get(currentPlayer).rotationCnt));
		rotationCntLabel.setForeground(Color.WHITE);
		rotationCntLabel.setFont(new Font("맑은 고딕", Font.BOLD, 17));
		caughtCntLabel.setText("잡은 수: "
				+ String.valueOf(players.get(currentPlayer).catchCnt));
		caughtCntLabel.setForeground(Color.WHITE);
		caughtCntLabel.setFont(new Font("맑은 고딕", Font.BOLD, 17));
